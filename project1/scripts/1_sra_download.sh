...
#SBATCH --array=1-6 # Change to represent the total number of samples in your file
################################################################################
...
DEST_DIR=/scratch/$USER/singlecellrna/project1/data

# Change this to the path where you stored your samples list
ACC_FILE=/scratch/$USER/singlecellrna/project1/samples_file.txt
